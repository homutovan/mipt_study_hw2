...
from settings import (
    POSITION_LINK_ATTR, COMPANY_LINK_ATTR, COMPANY_LINK_ATTR_ALT, 
    DESCR_LINK_ATTR, SKILLS_LINK_ATTR, VACANCY_LIST_ATTR, VACANCY_COUNT_ATTR, 
    VACANCY_LIST_ATTR,
)
...
class Vacancy:
    ...
    def _fill(self):
        ...
        if skills_tag:  
            self.key_skills = list(map(lambda x: {'name': x.text}, skills_tag.contents))
